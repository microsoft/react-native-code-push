 ...
 * https://raw.githubusercontent.com/facebook/react-native/86ff767268c0d6046a1d4c8af43e058249f89bbf/ReactAndroid/src/main/java/com/facebook/react/ReactInstanceManager.java
 *
 ...
 */
public class CodePushReactInstanceManager{

    /* should only be accessed from main thread (UI thread) */
    private final List<CodePushReactRootView> mAttachedRootViews = new ArrayList<>();
    ...
    private final ReactInstanceDevCommandsHandler mDevInterface =
            new ReactInstanceDevCommandsHandler() {
                ...
                public void onReloadWithJSDebugger(ProxyJavaScriptExecutor proxyExecutor) {
                    CodePushReactInstanceManager.this.onReloadWithJSDebugger(proxyExecutor);
                }

                @Override
                public void onJSBundleLoadedFromServer() {
                    CodePushReactInstanceManager.this.onJSBundleLoadedFromServer();
                }

                @Override
                public void toggleElementInspector() {
                    CodePushReactInstanceManager.this.toggleElementInspector();
                }
            };
    ...
    private final DefaultHardwareBackBtnHandler mBackBtnHandler =
            new DefaultHardwareBackBtnHandler() {
                ...
                public void invokeDefaultOnBackPressed() {
                    CodePushReactInstanceManager.this.invokeDefaultOnBackPressed();
                }
            };

    private CodePushReactInstanceManager(
     ...
     */
  /* package */ void attachMeasuredRootView(CodePushReactRootView rootView) {
        UiThreadUtil.assertOnUiThread();
     ...
     * first call.
     */
  /* package */ void detachRootView(CodePushReactRootView rootView) {
        UiThreadUtil.assertOnUiThread();
  ...
  /* package */ List<ViewManager> createAllViewManagers(
    ...
    private void initializeReactContext() {
        ...
        CodePush.CodePushReactPackage codePushReactPackage = null;
        for(ReactPackage reactPackage : mPackages){
            if(reactPackage instanceof CodePush.CodePushReactPackage) {
                codePushReactPackage = (CodePush.CodePushReactPackage)reactPackage;
            }
        }

        if (codePushReactPackage != null && codePushReactPackage.hasSavedBundle()){
            // Use JS file from file system
            recreateReactContext(
                    new JSCJavaScriptExecutor(),
                    CodePushJSBundleLoader.createFileLoader(
                            "",
                            codePushReactPackage.getBundleLocation()));
        } else {
    ...
    private void recreateReactContext(
        ...
        for (CodePushReactRootView rootView : mAttachedRootViews) {
    ...
    private void attachMeasuredRootViewToInstance(
            CodePushReactRootView rootView,
        ...
        for(ReactPackage aPackage : mPackages) {
            if (aPackage instanceof CodePush.CodePushReactPackage)
                ((CodePush.CodePushReactPackage) aPackage).setRootView(rootView);
        }
    ...
    private ReactApplicationContext createReactContext(
        ...
        CodePushCoreModulesPackage coreModulesPackage =
                new CodePushCoreModulesPackage(this, mBackBtnHandler);
    ...
    private void processPackage(
        ...
        for (NativeModule nativeModule : reactPackage.createNativeModules(reactContext)) {
            ...
            if(reactPackage instanceof CodePush.CodePushReactPackage) {
                ((CodePush.CodePushReactPackage) reactPackage).setInstanceManager(this);
            }
        }
    ...
    public static class Builder {
         ...
         * </ul>
         */
        public CodePushReactInstanceManager build() {
            ...
            CodePushReactInstanceManager codePushReactInstanceManager = new CodePushReactInstanceManager(
            ...
            return codePushReactInstanceManager;
        }
    }
}