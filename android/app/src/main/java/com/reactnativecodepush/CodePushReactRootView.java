 ...
 * https://raw.githubusercontent.com/facebook/react-native/42eb5464fd8a65ed84b799de5d4dc225349449be/ReactAndroid/src/main/java/com/facebook/react/ReactRootView.java
 *
 ...
 * that gesture).
 */
public class CodePushReactRootView extends SizeMonitoringFrameLayout implements RootView {

    private final KeyboardListener mKeyboardListener = new KeyboardListener();

    private @Nullable CodePushReactInstanceManager mReactInstanceManager;
    ...
    public CodePushReactRootView(Context context) {
        super(context);
    }

    public CodePushReactRootView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CodePushReactRootView(Context context, AttributeSet attrs, int defStyle) {
            ...
            UiThreadUtil.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    Assertions.assertNotNull(mReactInstanceManager)
                            .attachMeasuredRootView(CodePushReactRootView.this);
     ...
     */
    public void startReactApplication(CodePushReactInstanceManager reactInstanceManager, String moduleName) {
