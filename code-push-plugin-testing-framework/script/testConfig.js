...
exports.onlyRunCoreTests = TestUtil_1.TestUtil.resolveBooleanEnvironmentVariables(process.env.CORE);
exports.shouldSetup = TestUtil_1.TestUtil.readMochaCommandLineFlag(SETUP_FLAG_NAME);
exports.restartEmulators = TestUtil_1.TestUtil.resolveBooleanEnvironmentVariables(process.env.CLEAN);
