...
*Note: If you are using version 0.29+ of React Native, please refer to the [manual plugin installation steps](plugin-installation-android---manual) below instead as RNPM will not correctly link the plugin.*
