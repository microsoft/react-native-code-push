...
| I've released new update but code-push keeps rolling back(in case of android) | Be sure you have ReactInstance Manager implemented as a singleton(and shared across different activities / fragments) [more details](https://facebook.github.io/react-native/docs/integration-with-existing-apps)
