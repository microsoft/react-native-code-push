...
| I've released an update for ios platform but my android app also shows an update and it breaks it | Be sure you have different app keys for each platform per application in order to recieve updates correctly |
