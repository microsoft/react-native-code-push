...
| v0.46-v0.49             | v5.1+ *(RN removed unused registration of JS modules)*|
| v0.50+                  | TBD :) We work hard to respond to new RN releases, but they do occasionally break us. We will update this chart with each RN release, so that users can check to see what our "official" support is.
