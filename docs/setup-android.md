...
2. Add the Deployment key to `strings.xml` [Optional]:
...
3.  As per the note, setting CodePush Deployment Keys using codePushOptions from React Native's side is also an option.
